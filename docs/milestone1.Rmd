...
After using dummy variables for sex, smoker, and region, according to the correllogram below, smoker and charges has the strongest correlation of 0.79. No high collinearity between independent variables is observed.
