...
## Plan of Action
Our plan of action is to perform a linear regression analysis and plot the regression line and relevant variables. For that we are going to use all the variables except the children. These variables are needed to be normalaized before performing the regression analysis.  
