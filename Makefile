...
all: milestone3.html milestone3.pdf

# Download the raw data from an URL
data/raw/data.csv: scripts/load_data.R
	Rscript Rscript scripts/load_data.R --data_to_url="https://gist.github.com/meperezcuello/82a9f1c1c473d6585e750ad2e3c05a41/raw/d42d226d0dd64e7f5395a0eec1b9190a10edbc03/Medical_Cost.csv"
...
images/*.png: scripts/explore_data.R data/processed/processed_data.csv
	Rscript scripts/explore_data.R --processed_data="data/processed/processed_data.csv" --path_to_images="images"

# Perform linear regression
# PLACEHOLDER

docs/milestone3.html docs/milestone3.pdf: scripts/knit.R docs/milestone3.Rmd
